...
| 🤼 Grand Sumo — **Day 12, Ryogoku** (Sep 24) | ⬜ Not booked | Sales open **Aug 8 at 10:00 JST / 02:00 BST** on the official English Ticket Oosumo site. Target weekday Chair B: **£37 pp (¥7,000)** including the mandatory ¥2,000 service fee; **£74 (¥14,000) for two**. Print at 7-Eleven in Japan; non-refundable. |
...
- Arrival route: **Odoriko 9 direct, Tokyo 12:00 → Shuzenji 14:06**, then Tokai Bus for approximately eight minutes to **Shuzenji Onsen**. No hotel shuttle. The Mishima route is the disruption fallback.
...
- **Booked room:** 35m² Japanese-style room with two individual futons. The confirmation labels it “twin”; Nick confirmed this refers to the futon arrangement, not Western twin beds. The full Japanese room-category text did not render legibly.
...
| Odoriko 9 Tokyo→Shuzenji (Sep 25) | ⬜ Not booked | **Booking reminder: Aug 25 at 10:00 JST / 02:00 BST.** Reserve **Tokyo 12:00 → Shuzenji 14:06**; recheck the complete Tokyo–Shuzenji fare and ticket arrangement during purchase. Keep the Tokyo→Mishima→Shuzenji connection as disruption insurance. |
...
| Item | Status | Notes |
|------|--------|-------|
| Shinkansen Mishima→Kyoto (Sep 27) | ⬜ Not booked | SmartEX ordinary reserved fare currently **£58 pp (¥11,110)**. Prefer a westbound Hikari that stops at Mishima; otherwise follow SmartEX's Kodama/transfer routing. Only the small Shuzenji bag travels with you; the main case should already be at the Kyoto hotel. |
| Nozomi Shin-Osaka→Tokyo (Oct 3, departure day) | ⬜ Not booked | ~¥14,720 pp reserved, ~11:00 or 12:00 departure for a 3h+ HND cushion. SmartEX app. No oversized-baggage seat is needed if the main case has been forwarded to Haneda; reserve the correct seat if the fallback has a 161-250cm case travelling with you. |
| Luggage forwarding 1 — Tokyo→Kyoto | ⬜ Confirm hotel, then send | Before Sep 24, confirm that Mitsui Garden Hotel Kyoto Shinmachi Bettei will accept and hold a prepaid Yamato suitcase arriving Sep 25-26 for the Sep 27 reservation. Pack Sep 23; Hotel Monterey can arrange Yamato at its front desk 24 hours a day. Request Sep 26 delivery. |
...
| Ryogoku chanko/izakaya dinner (Sep 24, ~18:45–19:00) | ⬜ Not booked | Choose the restaurant after securing the sumo tickets, since the seat purchase is the more urgent task. |
